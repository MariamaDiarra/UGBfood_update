...
public class restaurants_publics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnRestoPublic= findViewById(R.id.btnLocation);
        ...
        btnRestoPublic.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void openActivitymenu(){
        Intent intent = new Intent(this, menuprive.class);
        startActivity(intent);
    }

    public void openActivitymenu2(){
        Intent intent2 = new Intent(this, menuprive.class);
