...
public class restaurants_prives extends AppCompatActivity {
    ...
    public void openActivitymenu3(){
        Intent intent3 = new Intent(this, menuprive.class);
        startActivity(intent3);
    }

    public void openActivitymenu4(){
        Intent intent4 = new Intent(this, menuprive.class);
        startActivity(intent4);
    }

    public void openActivitymenu5(){
        Intent intent5 = new Intent(this, menuprive.class);
        startActivity(intent5);
    }

    public void openActivitymenu6(){
        Intent intent6 = new Intent(this, menuprive.class);
        startActivity(intent6);
    }

    public void openActivitymenu7(){
        Intent intent7 = new Intent(this, menuprive.class);
        startActivity(intent7);
    }

    public void openActivitymenu8(){
        Intent intent8 = new Intent(this, menuprive.class);
